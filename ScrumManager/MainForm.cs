...
namespace ScrumManager
{
    public partial class MainForm : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            usersTableAdapter.Connection.ConnectionString = test.Connection.ConnectionString;
            usersTableAdapter.Fill(scrumManagerDataSet1.Users);
        ...
        DataGridViewRow currentproject;
        private void dataGridView2_CellMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            currentproject = dataGridView2.Rows[e.RowIndex];
        ...
        private void Projectdetail_CellMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            //ProjectID -> ProjectId
            projectdetail.DataSource = test.Sprints.Where(p => p.ProjectID == projectnum);
            TabPage tb = new TabPage("Sprint " + projectnum.ToString());
            tabControl1.TabPages.Add(tb);
            tb.Controls.Add(projectdetail);
            projectdetail.Dock = DockStyle.Fill;
            tabControl1.SelectedTab = tb;
